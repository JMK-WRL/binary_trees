...
/**
 * two_children - function that is getting the next successor using the min
...
/**
 *remove_type - function that is removing a node depending of its children
 *@root: node to remove
...
/**
 * bst_remove - removing a node from a BST tree
