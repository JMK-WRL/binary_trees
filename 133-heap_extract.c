...
/**
 * tree_height - measuring the height of a binary tree
...
/**
 * tree_size_h - measuring the sum of heights of a binary tree
 * @tree: pointer to the root node of the tree to measure the height
 *
 * Return: Height or 0 if tree is NULL
 */
...
/**
 * heapify - heapifies the max binary heap
...
/**
 * heap_extract - extracting the root node of a Max Binary Heap
