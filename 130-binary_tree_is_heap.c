...
/**
 * binary_tree_is_heap - checking if a binary tree is a valid Max Binary Heap
...
/**
 * btih_helper - checking if a binary tree is a valid Max Binary Heap
 * @tree: a pointer to the root node of the tree to check
 *
 * Return: 1 if tree is a valid Max Binary Heap
 *         1 if tree is NULL
...
/**
 * btic_helper - checking if a binary tree is complete
 * @tree: a pointer to the root node of the tree to check
